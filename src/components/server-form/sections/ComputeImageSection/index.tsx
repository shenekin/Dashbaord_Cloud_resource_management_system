...
export default function ComputeImageSection({ 
  ...
  return (
    <div className={`bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 overflow-hidden ${isDisabled ? 'opacity-50' : ''}`}>
      <div className="bg-gradient-to-r from-purple-500 to-purple-600 px-8 py-5">
        ...
        <p className="text-purple-100 text-sm mt-1.5">Select instance flavor, operating system, and admin credentials</p>
      </div>
      <div className="p-8">
        {isDisabled && (
