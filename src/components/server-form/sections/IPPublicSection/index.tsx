...
export default function IPPublicSection({ 
  ...
  return (
    <div className={`bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 overflow-hidden ${disabled ? 'opacity-50' : ''}`}>
      <div className="bg-gradient-to-r from-cyan-500 to-cyan-600 px-8 py-5">
        ...
        <p className="text-cyan-100 text-sm mt-1.5">Configure private IP, IPv6, and public IP settings</p>
      </div>
      <div className="p-8">
        {disabled && (
