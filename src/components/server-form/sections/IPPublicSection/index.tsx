...
export default function IPPublicSection({ 
  ...
  return (
    <div className={`bg-white/90 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200/50 overflow-hidden ${disabled ? 'opacity-50' : ''}`}>
      <div className="bg-gradient-to-r from-cyan-500 to-cyan-600 px-6 py-3.5">
        ...
        <p className="text-cyan-100 text-xs mt-1">Configure private IP, IPv6, and public IP settings</p>
      </div>
      <div className="p-5">
        {disabled && (
